...
export const getCurrentJsonRpcSignerFromMagic = () => {
  const provider = new Web3Provider(magic.rpcProvider as any)
  return provider.getSigner()
}

export const getEncryptionWalletFromMagic = async (signer: JsonRpcSigner) => {
...
export const getJsonRpcSignerFromSMS = async (phoneNumber: string) => {
