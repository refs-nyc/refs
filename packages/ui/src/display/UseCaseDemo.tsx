import { XStack, YStack, Text, Paragraph, View } from 'tamagui'
      ...
      <YStack flex={1} jc="center" ai="center" gap="$5">
        <XStack gap="$3" jc="flex-start" w="100%" px="$4">
          <Image
            ...
            source={require('../../../../apps/expo/assets/l11.png')}
          ></Image>
        ...
        <XStack gap="$3" jc="flex-start" w="100%" px="$4">
          <Image
            style={{ width: 54, height: 54 }}
            source={require('../../../../apps/expo/assets/l2.png')}
          ></Image>
          <View style={{ justifyContent: 'center' }}>
            <Paragraph size="$2" lh="$0.5">
        ...
        <XStack gap="$3" jc="flex-start" w="100%" px="$4">
          <Image
            style={{ width: 54, height: 54 }}
            source={require('../../../../apps/expo/assets/l3.png')}
          ></Image>
          <View style={{ justifyContent: 'center' }}>
            <Paragraph size="$2" lh="$0.5">
